...
>
    ...
    >
        <div class="flex flex-col items-center space-y-4 w-full sm:items-end">
            <div
                class="overflow-hidden w-full max-w-sm rounded-md border ring-1 ring-black ring-opacity-5 shadow-sm pointer-events-auto dark:bg-transparent border-sky-400 bg-white/60 backdrop-blur"
            >
                <div class="p-4">
