...
<div
    ...
    <label
        class="inline-block absolute left-2 -top-2 px-2 -mt-px text-xs font-medium text-gray-900 bg-white rounded-md"
    ...
    <input
        class="block p-0 w-full h-full placeholder-gray-500 text-gray-900 border-0 sm:text-sm focus:ring-0"
