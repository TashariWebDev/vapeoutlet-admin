    ...
    <div class="flex z-50 flex-col p-6 min-h-screen bg-white rounded">
      ...
      >
        <div class="grid grid-cols-4 w-full break-inside-avoid">
          ...
          <div class="px-1 text-xs text-right text-white uppercase bg-gray-700 border">Variance
          </div>
        </div>
        
        <div class="block break-before-avoid">
          @foreach ($stockTake->items as $item)
            <div class="grid grid-cols-4 py-1 w-full border-b break-after-avoid-page">
              <div class="p-1">
                <p class="text-xs font-semibold uppercase whitespace-pre-wrap">{{ $item->product->sku }}</p>
              </div>
