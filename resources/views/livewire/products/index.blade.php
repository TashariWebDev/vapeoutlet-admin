<div class="py-3">
    ...
    <header class="grid grid-cols-1 p-2 bg-white rounded-lg lg:grid-cols-2 lg:gap-x-2 dark:bg-slate-900">
    ...
    >
        <div class="flex justify-center py-4 space-x-1 lg:justify-end">
            <button class="py-1 px-3 text-xs font-semibold rounded border"
                    :class="show ==='detailed' ? 'bg-slate-300 text-slate-600' : 'bg-sky-600 text-white'"
                    x-on:click="show = 'simple'"
            >SIMPLE
            </button>
            <button
                class="py-1 px-3 text-xs font-semibold rounded border"
        ...
        <div class="py-2 bg-white rounded dark:bg-slate-900">
