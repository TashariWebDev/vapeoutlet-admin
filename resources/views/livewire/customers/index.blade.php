      ...
      <x-table.container>
        ...
        @forelse($customers as $customer)
          <x-table.body class="grid grid-cols-1 lg:grid-cols-5">
            ...
            <x-table.row
              class="text-xs font-semibold text-center lg:text-left text-slate-500">{{ strtolower($customer->email) }}</x-table.row>
            <x-table.row
              class="text-xs text-center text-slate-500">{{ $customer->phone }}</x-table.row>
