<div>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <a
            class="flex justify-center items-center w-full h-24 font-bold bg-white rounded-lg ring-blue-400 shadow dark:text-white hover:ring focus:ring text-slate-600 dark:bg-slate-800"
