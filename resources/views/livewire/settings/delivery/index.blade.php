<div>
    ...
    <x-slide-over title="Add delivery option"
    ...
    <div class="py-6">
        <div
            class="hidden lg:grid lg:grid-cols-6 border text-sm bg-white rounded-t text-sm font-semibold uppercase py-2 bg-gradient-slate text-white"
        >
            ...
            @forelse($deliveries as $delivery)
                ...
                >
                    <div class="border-r lg:py-2 lg:px-2 text-center lg:text-left col-span-2">
                        <div class="lg:hidden bg-gradient-slate text-white p-2">
                            <p>type</p>
                        </div>
                        <div class="lg:block flex items-center text-center lg:text-left p-2">
                            ...
                            <p class="text-slate-500 text-xs ml-2 md:ml-0">{{ $delivery->description }}</p>
                        </div>
                    </div>
            ...
            @empty
                <div class="py-6">
                    <div class="text-center py-10 bg-white rounded-md">
                        <x-icons.truck class="mx-auto h-12 w-12 text-slate-400"/>
