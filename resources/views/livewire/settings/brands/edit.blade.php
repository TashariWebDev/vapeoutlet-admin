<div>
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
        @foreach($brands as $brand)
            <div
                class="relative rounded-lg border border-slate-300 bg-white px-6 py-5 shadow-sm flex py-2 flex-wrap items-center space-x-3 hover:border-slate-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500"
            >
                ...
                <div class="flex-shrink-0">
                    <div class="pb-3">
                        <img class="h-10 w-10 bg-slate-100"
                             src="{{ $brand->image }}"
                             alt=""
                        >
                    </div>
                    <div class="relative w-48 h-6 py-2 bg-slate-200 flex justify-center items-center">
                        <input type="file"
                               wire:model="image"
