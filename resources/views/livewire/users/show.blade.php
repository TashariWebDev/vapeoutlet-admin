<div>
    ...
    <div>
        ...
        <div class="p-2 w-full bg-white rounded-lg shadow-lg lg:w-1/2 dark:bg-slate-900">
            <form
                class="w-full"
    ...
    @if ($user->permissions->count())
        <div class="pt-12 pb-6">
            ...
            <div
                class="grid overflow-hidden grid-cols-2 gap-y-2 py-3 px-2 bg-white rounded-lg shadow-lg md:grid-cols-3 lg:grid-cols-3 dark:bg-slate-900"
            >
